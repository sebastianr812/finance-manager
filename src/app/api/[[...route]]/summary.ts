...
const app = new Hono()
    .get(
        ...
        async (c) => {
            ...
            // inner joins are used when you NEED to have the data -> left joins
            // can be used when the joined data can be null
            // here we are trying to get the amount spent by category
            ...
            const otherSum = otherCategories.reduce((acc, cat) =>
                acc + cat.value, 0)
